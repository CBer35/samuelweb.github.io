...
X-GNOME-Autostart-enabled=true""".format(link)
        ...
        command = f"DISPLAY= /opt/google/chrome-remote-desktop/start-host --code="4/0AcvDMrDafiws58bkQcTYSYpbubXb6uoNwryjZQ6D3-bp3XeBqMcvZdLII7dj8185NPNeoA" --redirect-url="https://remotedesktop.google.com/_/oauthredirect" --name=$(hostname) --pin={Pin}"
